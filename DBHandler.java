...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_CONTACTS + "("
                ...
                + KEY_MEANING + " TEXT," +KEY_SENTENCE+" TEXT,"+KEY_STAR+" TEXT,"+KEY_VOICE+" TEXT"+")";
    ...
    void addContact(Contacts contact) {
        ...
        values.put(KEY_MEANING, contact.getMean()); // Contact Phone
        values.put(KEY_SENTENCE, contact.getSentence());
        values.put(KEY_STAR, contact.getStar());
        values.put(KEY_VOICE, contact.getVoice());
    ...
    Contacts getContact(int id) {
        ...
        Cursor cursor = db.query(TABLE_CONTACTS, new String[]{KEY_ID,
                        KEY_WORD_NAME, KEY_MEANING,KEY_SENTENCE,KEY_STAR,KEY_VOICE}, KEY_ID + "=?",
    ...
    public List<Contacts> getAllContacts() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                contact.setSentence(cursor.getString(3));
                contact.setStar(cursor.getString(4));
                contact.setVoice(cursor.getString(5));
